...
ChatCompletion _$ChatCompletionFromJson(Map<String, dynamic> json) => ChatCompletion(
...
Map<String, dynamic> _$ChatCompletionToJson(ChatCompletion instance) => <String, dynamic>{
  'id': instance.id,
